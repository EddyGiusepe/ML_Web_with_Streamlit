...
def main():
    ...
    st.sidebar.header('Eddy Giusepe')
    st.sidebar.markdown('e-mail para contato:')
    st.sidebar.markdown('eddychirinos.unac@gmail.com')
    st.sidebar.markdown('LinkedIn:')
    st.sidebar.markdown('https://www.linkedin.com/in/eddy-giusepe-chirinos-isidro-85a43a42/')
    st.sidebar.markdown('GitHub:')
    st.sidebar.markdown('https://github.com/EddyGiusepe')
    #st.sidebar.markdown('D3:')
    #st.sidebar.markdown('https://www.dadosaocubo.com')
    image = Image.open('Ufes.png')
    st.image(image, caption='A minha Alma mater', width=200)
    #st.image('Ufes.png', format='PNG')
